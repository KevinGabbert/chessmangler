...
namespace ChessMangler.WinUIParts
{
    public class ChessGrid_SquareHandlers
    {
        ...
        /// </summary>
        public void Add_Required_Square_Handlers(ChessGrid chessForm)
        {
            this.ChessGrid_Form = chessForm;
        ...
        private void CellMouseDown(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                ChessGrid_Form.Controls.Add(blank);
                blank.BringToFront();
            }
            ...
            ChessGrid_Form.Controls.Remove(blank);
        ...
        private void CellDragDrop(object sender, DragEventArgs e)
        {
            ...
            try
            {
                ...
                if (weCanMove)
                {
                    ...
                    ChessGrid_Form.UIBoard.ClearSquare(_dragStartSquare, true);
                    this.DebugForm.debugTextBox.Text += "\r\n Clear Square";
                }
                else
                {
